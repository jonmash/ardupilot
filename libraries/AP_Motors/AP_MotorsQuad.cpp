...
void AP_MotorsQuad::setup_motors()
{
    ...
    if( _flags.frame_orientation == AP_MOTORS_PLUS_FRAME ) {
        ...
        add_motor(AP_MOTORS_MOT_5,   0, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  1);
        ...
        add_motor(AP_MOTORS_MOT_5,  -45, -0.7981,  4);
        ...
        add_motor(AP_MOTORS_MOT_5,  -45, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 4);
        ...
        */
        ...
        add_motor(AP_MOTORS_MOT_5, -60, -60, 0, 4);
        ...
        */
        ...
        add_motor(AP_MOTORS_MOT_5,  -45, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  4);
